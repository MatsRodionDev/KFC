...
public static class ApplicationServiceCollection
{
    public static IServiceCollection AddApplicationLayer(this IServiceCollection services)
    {
        return services
            ...
            .AddScoped<IQueryHandler<GetProductsPagedQuery, PagedProductsResponse>, GetProductsPagedQueryHandler>()
            .AddScoped<IQueryHandler<GetIngredientsPagedQuery, PagedIngredientsResponse>, GetIngredientsPagedQueryHandler>()
            .AddScoped<IQueryHandler<GetToppingsPagedQuery, PagedToppingsResponse>, GetToppingsPagedQueryHandler>()
            .AddScoped<IQueryHandler<GetDrinksPagedQuery, PagedDrinksResponse>, GetDrinksPagedQueryHandler>()
